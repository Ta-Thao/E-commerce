        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="footer-menu">
                    ...
                    <ul>
                        <li><a href="/user/shop">Mac</a></li>
                        <li><a href="/user/shop">iPhone</a></li>
                        <li><a href="/user/shop">iPad</a></li>
                        <li><a href="/user/shop">AirPods</a></li>
                    </ul>
                </div>
            </div>
...
<script defer src="/resources/js/js/main.js"></script>
